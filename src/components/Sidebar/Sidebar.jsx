    ...
    <div className={styles.sidebar}>
      <div className={styles.sidebarContent}>
        ...
        <div className={styles.mainButtons}>
          ...
          <div className={styles.navButtons}>
            <Button variant={'Btn-icon'} icon={theme === 'light' ? faSun : faMoon} iconClassname={styles.infoIcon} className={`${styles.themeButton} ${location.pathname === '/about' ? styles.active : ''}`} onClick={() => setTheme(theme === 'light' ? 'dark' : 'light')} />
